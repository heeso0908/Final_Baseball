...
def show():
    page_hero(
        ...
        "특정 투수 한 명의 폼이 원인이 아니라, 접전 경기 운영·불펜 활용·선수 컨디션이 함께 만들어 낸 -9.06승 차이입니다.",
    ...
    finding_box(
        "9승 차이 중 약 70%는 경기 운영 방식으로 설명 가능",
        "162경기 × 20시즌 시뮬레이션 결과, 평균 83.95승이 나왔습니다.<br>"
        "기대치(90.06승)와의 차이 약 6.11승은 접전 상황에서의 투수 약화·마무리 투입 타이밍·불펜 공백 등으로 설명됩니다.<br>"
        "나머지 약 3승은 운이나 아직 발견하지 못한 요인으로 보입니다."
    )
    ...
    <div class="quote-card">
        ...
        <p>
        9승 차이 중 6승은 경기 운영 방식에서 설명되는 <b>발견된 원인</b>입니다.<br>
        나머지 3승과 그 이상의 향상도 현실적인 변화 범위 내에서 만회 가능한 조합이 존재합니다.<br>
    ...
    <div class="quote-card">
        ...
        <p>
        TEX 2025의 9승 차이는 한 가지 이유로 설명되지 않습니다.<br>
